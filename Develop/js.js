...
function generatePassword () {
    ...
    if (lowercase || uppercase || numbers || special) {
        ...
        if (uppercase){
            for (var i=0; i< uppercaseBank.length; i++){
                passwordBank.push(uppercaseBank[i]);
            }
        }
        if (numbers){
            for (var i=0; i< numericBank.length; i++){
                passwordBank.push(numericBank[i]);
            }
        }
        if (special){
            for (var i=0; i< specialBank.length; i++){
                passwordBank.push(specialBank[i]);
            }
        }
